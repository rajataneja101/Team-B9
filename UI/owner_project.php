...
$url = $apiUrl;
$res = $client->request('GET', $apiUrl."projects/getAllOwnerProjects/".$_SESSION['userId']);
					...
					<div class="product">
						...
						<div class="product-grid" style="background-image:url(images/person1.jpg);">
							<div class="inner">
								<p>
									<?php
									echo "<a class='icon' href=owner_project_detail.php?projectId=".$var[$j]['project']."><i class='icon-eye'></i></a>";
									?>
								</p>
							</div>
						</div>
						<div class="desc">
							<h3><?php
						echo "<h3><a class='icon' href=owner_project_detail.php?projectId=".$var[$j]['project'].">".$var[$j]['projectName']."</a></h3>";
